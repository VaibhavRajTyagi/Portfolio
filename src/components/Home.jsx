...
const Home = () => {
  ...
  return (
    <>
      <div className="landingDiv flex-grow h-full dark:bg-black dark:text-white flex flex-col md:flex-row justify-center items-center gap-20 md:gap-16 lg:gap-24 mt-28 md:mt-20 px-4">
